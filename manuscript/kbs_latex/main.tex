...
\begin{equation}
    ...
    \label{eq:eta}
\end{equation}
When training and evaluating within a fixed regime, we suppress the subscript $r$ for notational simplicity. A learned estimator $\hat{\eta}_r(z)=g_{\theta,r}(z)$ scores events by expected specialist-minus-base utility; Section~4 specifies its implementation.
...
\begin{equation}
    \mathcal{J}_r(a)
    =\mathbb{E}\!\left[a(Z)\left(\Delta_m(X)-\lambda C_m\right)\mid R=r\right].
